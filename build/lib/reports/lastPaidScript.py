...
fees_io = pd.read_csv(rf"C:\Users\jacob.sterling\advance.online\J Drive - Exec Reports\Margins Reports\Margins {Year}\Data\Week {Week}\fees retained io.csv",usecols=['PAYNO','Surname','Forename','CHQDATE','Solution'], encoding = 'latin')
fees_io['PAYNO'] = fees_io['PAYNO'].astype(int)
fees_io = fees_io.drop_duplicates(subset='PAYNO')
fees_axm = pd.read_csv(rf"C:\Users\jacob.sterling\advance.online\J Drive - Exec Reports\Margins Reports\Margins {Year}\Data\Week {Week}\fees retained axm.csv",usecols=['PAYNO','Surname','Forename','CHQDATE','Solution'], encoding = 'latin')
